...
function organizationCtrl($scope,organizationApi){
  ...
  $scope.updateOrganizations=updateOrganizations;
  ...
  function saveChangesToOrganizations($event){
    organizationApi.updateOrganizations($scope.organizationID, $scope.temporganizationOrganization, $scope.temporganizationType, $scope.temporganizationCity)
...
function organizationApi($http,apiUrl){
  return{
    ...
    updateOrganizations: function(id, organization, type, city){
      var url = apiUrl + '/updateOrganizations?organizationID=' + id + '&organization=' + organization + '&type=' + type + '&city=' + city;
      return $http.get(url);
    },
    queryOrganization: function(selectedSearchTerm, searchTerm){
      var url = apiUrl + '/queryOrganization?selectedSearchTerm=' +selectedSearchTerm + '&searchTerm=' + searchTerm;
